class NightVisionDevice:
    def __init__(self):
        self.commander_device: str | None = None
        self.driver_device: str | None = None
        self.pilot_device: str | None = None
        self.sight_device: str | None = None
        self.targeting_pod_device: str | None = None
        self.gunner_device: str | None = None
