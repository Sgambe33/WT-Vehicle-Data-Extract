...
class BallisticComputer(BaseModel):
    has_gun_ccip: bool = False
    has_turret_ccip: bool = False
    has_bombs_ccip: bool = False
    has_rocket_ccip: bool = False

    has_gun_ccrp: bool = False
    has_turret_ccrp: bool = False
    has_bombs_ccrp: bool = False
    has_rocket_ccrp: bool = False
